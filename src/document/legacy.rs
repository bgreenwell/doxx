...
use super::parsing::list::{group_list_items, is_likely_list_item};
// Import formatting and text extraction
use super::parsing::formatting::{
    extract_numbering_info, extract_paragraph_text, extract_run_formatting,
    reconstruct_heading_number,
};
